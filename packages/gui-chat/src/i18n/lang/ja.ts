export default {
    ...
    popup: {
        ...
        i_model: "モデルの実際の名前、例: gpt-5.2",
        i_title: "モデルの表示名、例: code-helper",
        i_baseURL: "モデルのAPIアドレス、例: https://api.openai.com/v1",
        i_host: "カスタムOllamaエンドポイント、例: http://localhost:11434",
        i_apiKey: "API キー、例: ",
        i_system: "カスタムシステムプロンプト",
        i_params: "カスタムモデル呼び出しパラメータ、例: ",
